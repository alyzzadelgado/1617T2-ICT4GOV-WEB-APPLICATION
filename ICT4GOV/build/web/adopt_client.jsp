...
<html lang="en">
  ...
  <body>
      ...
      int client;
        ...
        String query1;
        String query = "select * from user where officer_no = 3 order by last_name asc";
        ...
        {
            query1 = "select * from user where officer_no = 3 order by last_name asc limit 1";
        ...
        <div class="container">
          <div class="row row-centered">
            	<div class="main col-lg-8 col-centered">
              		<h1><strong>Adopt Taxpayer</strong></h1>
					<p> Select a taxpayer to adopt for future monitoring and appointments setting. <br><br></p>
                  ...
                  %>
                                    ...
                                    <form method="POST" action="ROAdopt">
                                            <label class="view-edit">Select Taxpayer</label><br>
                                            <select name="adoptClient" class="form-control">
                                                <% while (result.next()) {
                                                    %>
                                             ...
                                             <br>
                                            <input name="adopt" type="submit" value="Adopt" class="btn btn-default" style="float:right">
                                    </form>
