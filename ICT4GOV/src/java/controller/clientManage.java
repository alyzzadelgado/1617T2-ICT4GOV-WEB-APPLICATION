...
public class clientManage extends HttpServlet {
    ...
    
    {
        ...
        session.setAttribute("app_no", request.getParameter("app_no"));
        int app = Integer.parseInt(String.valueOf(session.getAttribute("app_no")));
        
        session.setAttribute("app_trans", request.getParameter("trans_no"));
        
        if (request.getParameter("view")!=null)
        {
            if (request.getParameter("app_status")!=null)
                session.setAttribute("app_accepted", request.getParameter("app_status"));
            
            nextStep = "/view_appointment.jsp";
        }
